...
- Story includes all devops-specific implementation requirements
...
- [ ] Devops requirements are explicitly stated

### Implementation Clarity (25 points)
- [ ] Story provides enough devops detail for implementation
- [ ] Technical constraints and assumptions are explicit
- [ ] Devops patterns and approaches are specified
...
- `implementation-clarity` - Missing devops details, unclear requirements
...
- `best-practices` - Violates devops standards
...
```json
{
  ...
  "strengths": ["What the Story does well from devops perspective"],
  "improvementPriorities": ["Top 3 improvements ranked by impact"],
  "readyForImplementation": boolean,
  "estimatedComplexity": "low|medium|high",
  "domainSpecificNotes": "Any additional devops context or implementation guidance"
}
```

## Scoring Guidelines

- **90-100 (Excellent)**: Crystal clear acceptance criteria, all devops details specified, highly testable
- **70-89 (Acceptable)**: Core requirements clear, minor gaps acceptable, implementable with clarification
- **0-69 (Needs Improvement)**: Critical ambiguities, missing devops requirements, must fix before implementation
...
```json
{
  ...
  "issues": [
    ...
    },
    {
      ...
      "description": "Missing devops implementation details: implementation approach",
      "suggestion": "Add technical requirements specific to devops.",
  ...
  "improvementPriorities": [
    ...
    "2. Add devops-specific implementation details",
