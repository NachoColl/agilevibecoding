...
- Story includes all data-specific implementation requirements
...
- Data best practices are followed
...
- [ ] Data requirements are explicitly stated

### Implementation Clarity (25 points)
- [ ] Story provides enough data detail for implementation
- [ ] Technical constraints and assumptions are explicit
- [ ] Data patterns and approaches are specified
...
- [ ] Follows data best practices
- [ ] Avoids data anti-patterns
...
- `implementation-clarity` - Missing data details, unclear requirements
...
- `best-practices` - Violates data standards
...
```json
{
  ...
  "strengths": ["What the Story does well from data perspective"],
  "improvementPriorities": ["Top 3 improvements ranked by impact"],
  "readyForImplementation": boolean,
  "estimatedComplexity": "low|medium|high",
  "domainSpecificNotes": "Any additional data context or implementation guidance"
}
```

## Scoring Guidelines

- **90-100 (Excellent)**: Crystal clear acceptance criteria, all data details specified, highly testable
- **70-89 (Acceptable)**: Core requirements clear, minor gaps acceptable, implementable with clarification
- **0-69 (Needs Improvement)**: Critical ambiguities, missing data requirements, must fix before implementation
...
```json
{
  ...
  "issues": [
    ...
    },
    {
      ...
      "description": "Missing data implementation details: implementation approach",
      "suggestion": "Add technical requirements specific to data.",
  ...
  "improvementPriorities": [
    ...
    "2. Add data-specific implementation details",
